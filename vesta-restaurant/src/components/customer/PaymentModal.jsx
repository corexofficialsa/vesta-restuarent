...
function detectCardType(number) {
  ...
  const madaBins = ['409201', '458456', '484783', '486094', '486095', '486096', '504300', '507860', '507861', '507862', '507863', '507864', '507865', '507866', '507867', '507868', '507869', '507900', '508160', '636120', '968201', '968202', '968203', '968204', '968205', '968206', '968207', '968208', '968209', '968210', '968211'];
...
function CardTypeIcon({ type }) {
  if (type === 'visa') return (
    <span className="text-[10px] font-black italic tracking-tighter text-blue-700 bg-white px-1.5 py-0.5 rounded">VISA</span>
  );
  ...
  if (type === 'mada') return (
    <span className="text-[10px] font-black text-green-700 bg-white px-1.5 py-0.5 rounded tracking-wide">مدى</span>
  );
  return null;
}
...
function CardPreview({ number, name, expiry, cardType }) {
  ...
  return (
    <div className={`relative w-full h-44 rounded-2xl bg-gradient-to-br ${gradient} p-5 text-white shadow-xl overflow-hidden mb-5 transition-all duration-500`}>
      ...
      <div className="font-mono text-lg tracking-widest mb-4 flex gap-2">
        {chunks.map((chunk, i) => (
          <span key={i} className={chunk.trim() ? 'text-white' : 'text-white/30'}>
            {chunk.trim() || '····'}
          </span>
        ))}
      </div>
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm font-semibold uppercase tracking-wide truncate max-w-[150px]">
            {name.trim() || 'YOUR NAME'}
          </p>
        </div>
...
export default function PaymentModal({ total, vat, onSuccess, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end sm:justify-center sm:items-center">
      ...
      {/* Sheet */}
      <div className="relative bg-white w-full sm:max-w-md sm:rounded-3xl rounded-t-3xl shadow-2xl overflow-hidden animate-slide-up max-h-[95vh] flex flex-col">
        ...
        {step === 'method' && (
          <>
            <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-gray-100 flex-shrink-0">
              <div>
                <h2 className="font-bold text-gray-900 text-lg">Choose Payment</h2>
                <p className="text-gray-400 text-xs mt-0.5">Total: {CURRENCY} {grand}</p>
              </div>
            ...
            <div className="p-5 space-y-3 overflow-y-auto">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-black text-white font-semibold text-base hover:bg-gray-900 active:scale-95 transition-all duration-200 shadow-lg"
              >
              ...
              {/* Mada */}
              <button
                onClick={() => handleCardMethod('mada')}
                className="w-full flex items-center gap-4 p-4 rounded-2xl border-2 border-gray-200 hover:border-green-400 hover:bg-green-50 active:scale-95 transition-all duration-200"
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-gray-900 text-sm">Mada</p>
                  <p className="text-gray-400 text-xs">Saudi debit card</p>
                </div>
              ...
              {/* Visa / Credit Card */}
              <button
                onClick={() => handleCardMethod('visa')}
                className="w-full flex items-center gap-4 p-4 rounded-2xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 active:scale-95 transition-all duration-200"
              >
              ...
              <div className="flex items-center justify-center gap-2 pt-1">
                ...
                <span className="text-[10px] text-gray-400">256-bit SSL · Secured by PCI DSS</span>
              </div>
            </div>
          </>
        )}
            ...
            <div className="flex items-center gap-3 px-5 pt-5 pb-4 border-b border-gray-100 flex-shrink-0">
              ...
              <div>
                <h2 className="font-bold text-gray-900 text-base">
                  {method === 'mada' ? 'مدى Mada Card' : 'Credit / Debit Card'}
                </h2>
                <p className="text-gray-400 text-xs">{CURRENCY} {grand} total</p>
              </div>
            </div>
            ...
            <div className="p-5 overflow-y-auto flex-1 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm font-mono text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400 transition-all pr-12
                      ${errors.number ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2">
                    <CardTypeIcon type={method === 'mada' ? 'mada' : cardType} />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm font-mono text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400 transition-all
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm font-mono text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400 transition-all pr-10
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border text-sm uppercase tracking-wide text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400 transition-all
              ...
              <button
                onClick={submit}
                className="w-full py-4 rounded-2xl bg-purple-700 text-white font-bold text-sm hover:bg-purple-800 active:scale-95 transition-all duration-200 shadow-lg shadow-purple-200 flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                Pay {CURRENCY} {grand}
              </button>

              <p className="text-center text-[10px] text-gray-400">Demo mode · No real charges will be made</p>
            </div>
          </>
        )}
        ...
        {step === 'success' && (
          <div className="flex flex-col items-center justify-center py-20 px-8 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">{CURRENCY} {grand} · Your order is being prepared</p>
            </div>
          </div>
        )}
      </div>
